    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4, fetch('https://api.openweathermap.org/data/3.0/onecall?lat=-14.796581726513459&lon=-39.173008679879025&exclude=minutely,hourly&units=metric&appid=70fd9d2c18a3ccd0fadf64377139e91d&lang=pt_br')];
                case 1:
                    resposta = _a.sent();
                    return [4, resposta.json()];
                case 2:
                    temperatura = _a.sent();
                    ...
                    return [2, { temperaturaAtual: temperaturaAtual, descricaoTempoAtual: descricaoTempoAtual, tempMaximaHoje: tempMaximaHoje, tempMinimaHoje: tempMinimaHoje }];
                case 3:
                    error_1 = _a.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4, fetch('https://newsapi.org/v2/everything?sortBy=publishedAt&apiKey=e10349f1a5334964a73e16a7740b669a&q=Universidade Estadual de Santa Cruz&language=pt')];
                case 1:
                    resposta = _a.sent();
                    return [4, resposta.json()];
                case 2:
